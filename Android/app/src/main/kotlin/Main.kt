...
internal val logger: SkipLogger = SkipLogger(subsystem = "fire.side.fuse", category = "FireSideFuse")
...
open class AndroidAppMain: Application {
    ...
    override fun onCreate() {
        ...
        FireSideFuseAppDelegate.shared.onInit()
    }
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onResume() {
        super.onResume()
        FireSideFuseAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        FireSideFuseAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        FireSideFuseAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        FireSideFuseAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        FireSideFuseAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            FireSideFuseRootView().Compose(context = contentContext)
        }
    }
}
